...
#      {'id':2, 'name':'Lets Learn Web Development' },
...
def registerPage(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'An error occurred durring registration')
...
def activityPage(request):
    ...
    return render(request, 'pages/activity.html', {'rooms_messages':rooms_messages})